...
void ChkMissRes(PDB *,bool *);
void ShiftMissRes(PDB *,bool *);
int SetCaCoords(PDB *);
...
double in_pro(double,double,double,double,double,double);/*内積*/


//void sch(PDB *,PDB *,MAT *,PDB *,CMD *);/*サーチエンジン*/
void sch(PDB *,PDB *,GRID *,GRID *,PDB *,CMD *);/*サーチエンジン*/
double sco(PDB *);/*スコア計算*/
double Mcounter(PDB *,PDB *,MAT *,CMD *);/*マトリクスからの自由エネルギー計算*/
double Gcounter(PDB *,PDB *,GRID *,GRID *,CMD *);//get score from grid data

int MVandSCORE(SCO *,PDB *,PDB *,PDB *,GRID *,GRID *,CMD *,MAT *,float,int,int,int,int,int);//移動とスコア計算

void result(PDB *,char);/*結果*/
float vdw_aa(char *);
